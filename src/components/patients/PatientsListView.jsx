...
function PatientListCard({ patient, selected, onSelect, getPatientInitials }) {
  ...
  return (
    <button
      ...
      className={`flex w-full min-w-0 items-center gap-3 rounded-xl border px-4 py-3 text-left transition-colors duration-100 sm:min-h-[76px] sm:gap-4 sm:px-5 sm:py-4 md:rounded-2xl md:gap-5 md:min-h-[84px] md:px-5 md:py-4 lg:min-h-[88px] lg:px-6 lg:py-5 ${
        selected
          ? 'border-[#00a88e] bg-emerald-50/60 hover:bg-emerald-50/60'
      ...
      <div className="flex w-full min-w-0 flex-col gap-5 lg:flex-row lg:items-start lg:gap-5">
        <div className="flex min-w-0 flex-1 flex-col lg:min-w-[min(100%,19rem)]">
          ...
          <div className="relative min-w-0 overflow-x-hidden [-webkit-overflow-scrolling:touch]">
            ...
            <ul className="flex list-none flex-col gap-y-2 sm:gap-y-2 md:gap-y-3 lg:gap-y-3" aria-label="Lista de pacientes">
